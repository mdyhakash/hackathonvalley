...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      <div className="hidden w-full lg:flex justify-center gap-5">
        {headerData.map((item) => (
          <Link
            key={item.id}
            href={item.href}
      ...
      <div className="flex gap-4 items-center">
        ...
        <button className="lg:hidden flex items-center justify-center bg-gradient-to-r from-[#C2CE3B] to-[#60BA08] px-3 h-[48px] text-black font-bold">
          <FaBars />
        </button>
      </div>
